...
#        return trend_score,"bullish" if trend_score >= 0.7 else trend_score,"bearish" if trend_score <= 0.3 else trend_score,"neutral"
    ...
    def adjust_parameters(self, trend, trendscore,volatility, df, mid_price, is_retracing, retrace_zone):
        ...
        # 📈 Add volatility-aware spread padding
        #volatility_spread_boost = natr_pct * Decimal("0.5")
        #bid_spread += volatility_spread_boost
        #ask_spread += volatility_spread_boost
